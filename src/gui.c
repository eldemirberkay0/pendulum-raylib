...
void UpdateGUI(void)
{
    ...
    if (GuiButton((Rectangle){60, 200, 100, 20}, "Add Circle")) { AddCircle((Vector2){lastCircle->center.x, lastCircle->center.y + newLength}, guiCircle->radius, guiCircle->color, guiCircle->angularSpeed); }
